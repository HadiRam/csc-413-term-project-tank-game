...
public class AiTankFastMover extends Tank{

    public AiTankFastMover(String id, double x, double y, double angle, double width, double height){
    ...
    public void move(GameWorld gameWorld){
        ...
        //This tank quckly pushes forward towards the player, then stops for a short time
        ...
        //allows the ai tank to fire a shell but slower than the slow moving tank.
        //this gives the fast moving tank a draw back to not be too overpowered.

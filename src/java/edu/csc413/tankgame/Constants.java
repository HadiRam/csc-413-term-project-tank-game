...
public class Constants {
    ...
    public static final double TANK_X_LOWER_BOUND = 7.0;
    public static final double TANK_X_UPPER_BOUND = 947.0;
    public static final double TANK_Y_LOWER_BOUND = 7.0;
    public static final double TANK_Y_UPPER_BOUND = 671.0;
